...
<div class="content-top ">
	<div class="container ">
		<div class="spec ">
			...
			<div class="tab-head ">
				<nav class="nav-sidebar">
					<ul class="nav tabs ">
					  <li class="active"><a href="#tab" data-toggle="tab">All Sellers</a></li>
            <?php
              ...
              $merchantArray = array();
              $sql = "SELECT merchantid, merchantname, url FROM merchant";
              ...
              if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                  ...
                  $url = (string) $row['url'];
              ?>
                  <li class=""><a href="#tab<? echo $merchantid?>" data-toggle="tab"><? echo $merchantname?></a></li>
          <?php
          // create curl resource
          $ch = curl_init();

          // set url
          curl_setopt($ch, CURLOPT_URL, $url.'getAllProductList.php');
          ...
          $output = curl_exec($ch);
          $productData[$merchantid]=$output;
          $productData2[$merchantid]=$output;
          //echo $output;
        ...
        <?php
          while(list($key, $val) = each($productData2)) {
            $merchantid = $key;
            $prodList = json_decode($val, true);
        ?>

					<div class="tab-pane text-style" id="tab<? echo $merchantid?>">
						<div class=" con-w3l">
              <?php
              ...
              ?>
							<div class="col-md-3 m-wthree">
								<div class="col-m">
										<img src="<? echo $row["imageUrl"]?>" class="img-responsive" alt="">
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.php?productId=<? echo $row["productId"]?>&merchantId=<? echo $key?>"><? echo $row["productName"]?></a></h6>
										</div>
										<!--<div class="mid-2">
										...
										<div class="add">
										   <a href="single.php?productId=<? echo $row["productId"]?>&merchantId=<? echo $key?>"><button class="btn btn-danger my-cart-btn my-cart-b " data-id="1" data-name="Moong" data-summary="summary 1" data-price="1.50" data-quantity="1" data-image="images/of.png">View</button></a>
										</div>
        ...
        <div class="tab-pane active text-style" id="tab">
          <div class=" con-w3l">
        <?php
          while(list($key, $val) = each($productData)) {
            $merchantid = $key;
            $prodList = json_decode($val, true);
        ?>
...
<div class="content-mid">
    ...
    <div class="row">
		<div class="col-md-4 m-w3ls">
			<div class="col-md1 ">
				<a href="http://thebookstore.nishantrathi.com/">
					<img src="images/bookstore.jpg" class="img-responsive img" alt="">
					<div class="big-sa">
						<h6>Nishant Rathi</h6>
						<h3>TheBook<span>Store </span></h3>
						<p>Handpicked great books of all time that one should definitely read.</p>
					</div>
				</a>
			</div>
		</div>
    <div class="col-md-4 m-w3ls">
			<div class="col-md1 ">
				<a href="http://thepk.xyz/">
					<img src="images/co1.jpg" class="img-responsive img" alt="">
					<div class="big-sa">
						<h6>Purvesh Kothari</h6>
						<h3>Grocery <span>Store </span></h3>
						<p>Make your food spicy.</p>
					</div>
				</a>
			</div>
		</div>
    <div class="col-md-4 m-w3ls">
			<div class="col-md1 ">
				<a href="http://ecommercefun.com/">
					<img src="images/co1.jpg" class="img-responsive img" alt="">
					<div class="big-sa">
						<h6>Meet Shah</h6>
						<h3>Super <span>Store </span></h3>
						<p>Meet your daily needs.</p>
					</div>
				</a>
			</div>
		</div>
  ...
  <div class="row">
    ...
    <div class="col-md-4 m-w3ls">
			<div class="col-md1 ">
				<a href="https://revival.000webhostapp.com/">
					<img src="images/spa.jpg" class="img-responsive img" alt="">
					<div class="big-sa">
						<h6>Pooja Patel</h6>
						<h3>Revival <span>SPA </span></h3>
						<p>Revive you body and mind.</p>
					</div>
				</a>
			</div>
		</div>
    <div class="col-md-4 m-w3ls">
			<div class="col-md1 ">
				<a href="https://between-the-lines.000webhostapp.com/">
					<img src="images/bookstore2.jpg" class="img-responsive img" alt="">
					<div class="big-sa">
						<h6>Salauni Patel</h6>
						<h3>Between the <span>Lines </span></h3>

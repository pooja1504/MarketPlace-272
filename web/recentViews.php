...
<div class="content-top ">
	<div class="container ">
        ...
        <table class="table table-hover table-bordered">
          <tr><th>Name</th><th>Time</th><th>View Again</th></tr>
          <?php
          // Database connection parameters
        	...
        	$sql = "SELECT merchantid, productid, userid, email, productName, ts from productvisitlog WHERE userid='121' AND email='abc@gmail.com' order by ts desc";
          ...
          ?>
            <tr><td><? echo $row["productName"]?></td><td><? echo $row["ts"]?></td><td><a href="single.php?productId=<? echo $row["productid"]?>&merchantId=<? echo $row["merchantid"]?>">View Again</a></td></tr>
          <?php
        }
        ?>
        </table>
